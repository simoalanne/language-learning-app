...
import type { LanguageName, WordGroup, WordGroupInput, WordGroupTranslation } from "@/types/api";
              ...
              {translations.map((translation, index) => (
                <TranslationCard
                  ...
                  setSelectedLanguage={(language) =>
                    handleTranslationChange(index, "languageName", language as LanguageName)
                  }
        ...
        <Box sx={{ display: "flex", justifyContent: "center" }}>
          <QuickAdd
            ...
            setSelectedLanguage1={(language) =>
              handleTranslationChange(0, "languageName", language as LanguageName)
            }
            setSelectedLanguage2={(language) =>
              handleTranslationChange(1, "languageName", language as LanguageName)
            }
